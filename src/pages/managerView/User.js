...
function User() {
  ...
  const sampletabledata = [
    ...
    {id: "A00044", state: "Karnatka", bankName: "Dhanlakshmi bank", personName: "Pavitran", mob: "XXXXXX8867", email: "abc@XXX.com", title: "total success cases are 627 sir for us, but dashboard shows only 471 for 21-22 HQ admin - XXXXXX1170", priority: "Normal", category: "", type: "KCC-ISS",  assignto: "Developer", stat: "In Progress", created: "20/01/2023 00:00:00", link: [0, 1, 2, 3], description: ''},
  ...
  return (
    <div className="container-new">
      ...
      <MainHome tabledata={sampletabledata}/>
    </div>
  );

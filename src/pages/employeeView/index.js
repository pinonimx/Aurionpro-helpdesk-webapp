...
export default function EmployeeView(){
  ...
  return (
    <div className="container-new">
      ...
      {mainPageState2 === 'Raise a request' ? <RaiseARequest /> : mainPageState2 === 'Queues' ? <MainHome tabledata={mainPageState.trim() === 'View entire queue' ? sampletabledata : filteredIssues} title={mainPageState} unFilteredData={sampletabledata} pageState={mainPageState2} /> : <Reports data={data} />}
    </div>
  );
}